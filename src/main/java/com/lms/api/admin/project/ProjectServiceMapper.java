...
import com.lms.api.admin.project.dto.ProjectFunctionResponse;
...
public interface ProjectServiceMapper {
    ...
    @Mapping(target = "projectFunctionId", source = "id")
    ...
    ProjectFunctionResponse.Function toFunction(ProjectFunctionEntity projectFunctionEntity);
